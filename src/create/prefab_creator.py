...
def create_expolsion(world: esper.World, pos: pygame.Vector2, explosion_info: dict):
...
def create_player_square(world: esper.World, player_info: dict, player_lvl_info: dict) -> int:
    ...
    size=(size[0]/player_info["animations"]["number_frames"],
            size[1]/player_info["animations"]["number_frames"])
...
def create_bullet(world: esper.World,
    ...
    pos = pygame.Vector2(player_pos.x + (player_size[0] / 2)-(bullet_size[0]/2), player_pos.y + (player_size[1] / 2)-(bullet_size[0]/2))
